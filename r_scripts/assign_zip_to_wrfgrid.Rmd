...
proportion_intersect <- function(poly, grid){
...
grid_to_poly <- function(prop_int_df, group_column) {
  # I think I might have county in 
...
co_county_id2 <- grid_to_poly(co_county_df, WRFCHEM_ID)
```
...
co_county_df <- proportion_intersect(poly = colorado_county,
                                     grid = wrf_grid)
